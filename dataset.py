...
class DCLDataset(data.Dataset):
    def __init__(self, root, meta_path, swap_size=None, transforms=None, mode='train', cls_2=True, cls_2xmul=False):
        super().__init__()
...
def collate_fn4pred(batch):
    ...
    return torch.stack(imgs, 0), img_name
